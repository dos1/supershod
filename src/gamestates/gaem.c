...
void Gamestate_Start(struct Game* game, struct GamestateResources* data) {
	...
	TM_AddAction(data->timeline, ShowTime, TM_AddToArgs(NULL, 1, data));
	TM_AddDelay(data->timeline, 4000);
	TM_AddAction(data->timeline, HideTime, TM_AddToArgs(NULL, 1, data));
	TM_AddDelay(data->timeline, 15000);
	TM_AddAction(data->timeline, ShowMove, TM_AddToArgs(NULL, 1, data));
	TM_AddDelay(data->timeline, 6000);
	TM_AddAction(data->timeline, ShowMove2, TM_AddToArgs(NULL, 1, data));
	TM_AddDelay(data->timeline, 4000);
	TM_AddAction(data->timeline, ShowMove3, TM_AddToArgs(NULL, 1, data));
	TM_AddDelay(data->timeline, 4000);
	TM_AddAction(data->timeline, ShowMove4, TM_AddToArgs(NULL, 1, data));
	TM_AddDelay(data->timeline, 4000);
	TM_AddAction(data->timeline, ShowMove5, TM_AddToArgs(NULL, 1, data));
